								...
								<div class="products-nav clearfix">
									...
									<nav class="kabu-navigation">
										<ul class="pagination">
											...
											<li class="page-item"><a class="page-link" href="#">4</a></li></li>
											<li class="page-item"><a class="page-link" href="#">5</a></li></li>
									...
									<div class="col-sm-3 col-6">
										<div class="product-item"><!-- product item -->
											...
											<div class="description">
												<h5>Ba lô da nữ dễ thương tặng gấu và móc BL458</h5>
												<p class="price-sale">
													<span class="final-price">66.500 đ
													<span class="price-regular">95.500 đ</span><span class="sale-tag sale-tag-square">30%</span>
												</p>
											</div>
										</div>
									</div>
