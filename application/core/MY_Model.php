...
class MY_Model extends CI_Model {
	...
	function createThumb($image, $upload_path='assets/uploads/images/thumb/products/') {
		if ($image != '') {
	...
	function pagination($base_url='admin/products/',$total=10,$per_page=10,$uri_segment=3) {
